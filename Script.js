// Pingu AI Core - Version 2.0 - FULLY FIXED
class PinguAI {
    constructor() {
        this.config = null;
        this.memory = null;
        ...
        // Bind methods to ensure 'this' works in event listeners
    ...
    async init() {
        ...
        setTimeout(() => {
            if (this.memory && this.memory.bot_profile) {
        ...
        this.recognition.onend = () => {
            if (this.isFullDuplex) {
                ...
                try {
                    ...
                    console.log('Duplex auto-restart failed');
                }
            } else {
                this.resetVoiceState();
                this.animateLevelBars(false);
